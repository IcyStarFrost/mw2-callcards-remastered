...
-- snd              | String or "none" for no sound or nil |   The sound effect to play instead of the default
...
function MW2CC:EntKilled( victim, attacker )
    ...
    local timeout = rapidtimeout:GetFloat()
    ...
    if attacker.mw2cc_killstreak % ksthreshold:GetInt() == 0 then
